...
struct CheckoutView: View {
    ...
    static let paymentTypes = [
        "Cash", "Credit Card", "iDine Points"
    ]
    static let pickupTimes = [
    "Now", "Tonight", "Tomorrow Morning"]
    ...
    var body: some View {
        Form {
            ...
            Section {
                Picker("When do you want to pickup?",
        ...
        .alert(isPresented: $showingPaymentAlert) {
            Alert(title: Text("Orer confirmed"), message: Text("Your total was $\(totalPrice, specifier: "%.2f") - thank you!"), dismissButton: .default(Text("OK")))
        }
    }
}
